 ...
 */
public class TaskListarContatosBloqueados extends GenericTask {
    public TaskListarContatosBloqueados(int requestCode, OnFinishTask onFinishTask) {
    ...
    protected Object[] doInBackGround(Object... params) throws IOException, MensagensException {
        ...
        return new Object[]{web.listarContatosBloqueadosDoUsuario(usuario)};
    }
}
