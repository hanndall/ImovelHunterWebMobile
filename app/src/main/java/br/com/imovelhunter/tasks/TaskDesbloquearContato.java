 ...
 */
public class TaskDesbloquearContato extends GenericTask {

    public TaskDesbloquearContato(int requestCode, OnFinishTask onFinishTask) {
    ...
    protected Object[] doInBackGround(Object... params) throws IOException, MensagensException {
        ...
        return new Object[]{web.desbloquearUsuario(usuarioBloqueador,usuarioBloqueado)};
    }
}
