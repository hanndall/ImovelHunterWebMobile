 ...
 */
public class TaskListarBairrosPorCidade extends AsyncTask<Object,Object,Object[]> {

    private int requestCode;

    private OnFinishTask onFinishTask;

    public TaskListarBairrosPorCidade(int requestCode,OnFinishTask onFinishTask){
    ...
    protected Object[] doInBackground(Object... params) {
        ...
        Cidades cidade = (Cidades)params[1];

        try {
            return new Object[]{web.listarBairrosPelaCidade(cidade)};
        } catch (IOException e) {
            e.printStackTrace();
            return null;
